...
const Color kPurple = Color(0xFFF48FB1);
const Color kLightBrown = Color(0xFFD2A58C);
const Color kPink = Color(0xFFF8BBD0);
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
          ...
          colorScheme: ColorScheme.fromSeed(
            seedColor: kPurple, // Our new primary color
            brightness: Brightness.light,
            primary: kPurple,
            onPrimary: Colors.pink[100],
            secondary: kLightBrown,
            background: kPink, // Our new app background
          ),
          useMaterial3: true,
          ...
          elevatedButtonTheme: ElevatedButtonThemeData(
            style: ElevatedButton.styleFrom(
              backgroundColor: kPurple, // Use our new brown
          ...
          inputDecorationTheme: InputDecorationTheme(
            ...
            labelStyle: TextStyle(color: kPurple.withOpacity(0.8)),
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: const BorderSide(color: kPurple, width: 2.0),
            ),
          ),
          ...
          cardTheme: CardThemeData(
            ...
            color: Colors.white70, // Pure white cards on the off-white bg
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(12),
            ),
